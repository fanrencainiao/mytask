...
layui.use(['bodyTab','form','element','layer','jquery'],function(){
	...
	console.log("昵称："+localStorage.getItem("name"));
	if(undefined == localStorage.getItem("name") || null == localStorage.getItem("name")){
		console.log("缓存清空后重新登录......")
        location.replace("./login.html");
	}
	$(".adminName").append(name+":"+localStorage.getItem("name"));
